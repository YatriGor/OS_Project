...
const DiningPhilosophers = () => {
  ...
  return (
    <div className="container mx-auto">
      <h1 className="text-3xl font-bold mb-4">Dining Philosophers Problem with Semaphores</h1>
      {philosophers.map((philosopher) => (
        <div key={philosopher.id} className="border border-gray-200 p-4 rounded-lg mb-4">
          <p className="text-lg font-semibold">Philosopher {philosopher.id}</p>
          <p className="mb-2">State: {philosopher.state}</p>
